...
const luoLiTi = fs.readFileSync(path.join(__dirname, "../HinaMincho-Regular.ttf"));

fs.writeFileSync(path.join(__dirname, "../HinaMincho-Regular.woff2"), ttf2woff2(luoLiTi));
